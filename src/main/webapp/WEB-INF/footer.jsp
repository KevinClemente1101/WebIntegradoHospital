...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>            
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <h5>Contacto</h5>
                            <ul class="list-unstyled">
                                <li><i class="fas fa-map-marker-alt"></i> Direcci�n: Calle 123, Ciudad</li>
                                <li><i class="fas fa-phone"></i> Tel�fono: +123 456 7890</li>
        ...
        <!-- Script principal de Flatpickr, el plugin de selecci�n de fechas y horas. -->
        <script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
        <!-- Script de localizaci�n de Flatpickr para espa�ol (traducci�n de los textos del calendario). -->
