...
<div class="container-fluid mt-4">
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      <p>
        Define los días y las horas en los que estarás disponible para atender
        citas.
      </p>
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          <form
            action="${pageContext.request.contextPath}/doctor/horarios"
            method="post"
          >
                  ...
                  <tr>
                    ...
                    <td>                                            
                        <form action="${pageContext.request.contextPath}/doctor/horarios" method="post" style="display:inline;">
                            ...
                            <input type="hidden" name="horario_ids" value="${horario.id}">
                ...
                <c:if test="${empty horarios}">
                  <tr>
                    <td colspan="4" class="text-center">
                      Aún no has configurado ningún horario.
                    </td>
                  </tr>
                </c:if>
              </tbody>
