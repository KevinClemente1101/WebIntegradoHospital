...
@WebServlet("/recepcionista/pacientes")
public class RecepcionistaPacientesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/recepcionista/pacientes.jsp").forward(request, response);
