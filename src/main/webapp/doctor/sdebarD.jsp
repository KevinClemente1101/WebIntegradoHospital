...
<div class="list-group">
    <a href="${pageContext.request.contextPath}/doctor/dashboard" class="list-group-item list-group-item-action <c:if test='${pageContext.request.servletPath == "/doctor/dashboardD.jsp"}'>active</c:if>'">
