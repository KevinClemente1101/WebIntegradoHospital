...
@WebServlet("/admin/eliminar-paciente")
public class AdminEliminarPacienteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            request.getRequestDispatcher("/admin/confirmar_eliminar_paciente.jsp").forward(request, response);
