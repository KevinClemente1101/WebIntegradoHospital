    ...
    <div class="col-md-9">
      ...
      >
        ...
        <div class="mb-3">
          ...
          <small class="form-text text-muted">
            Mínimo 8 caracteres, debe contener mayúscula, minúscula, número y
            carácter especial
          </small>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <small class="form-text text-muted"
            >Formato: +51 + 9 dígitos (ejemplo: +51987654321)</small
          >
        </div>
        <div class="mb-3">
        ...
        <div id="doctorFields" style="display: none">
          ...
          <div class="mb-3" id="codigoColegiaturaField">
            <label for="codigo_colegiatura" class="form-label"
              >Código de Colegiatura</label
            >
            <input
              type="text"
              class="form-control"
              id="codigo_colegiatura"
      ...
      <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
          ...
          const codigoColegiaturaField = document.getElementById(
            "codigo_colegiaturaField"
          );
          ...
          document
            .getElementById("codigo_colegiatura")
            .addEventListener("input", function () {
          ...
          document
            .getElementById("especialidad_id")
            .addEventListener("change", function () {
        ...
        function validateTelefono(input) {
          ...
          if (!pattern.test(telefono)) {
            showError(
              input,
              "Formato: +51 seguido de 9 dígitos (ejemplo: +51987654321)"
            );
            return false;
          } else {
            hideError(input);
        ...
        function validatePassword(input) {
          ...
          if (!pattern.test(password)) {
            showError(
              input,
              "Debe contener mayúscula, minúscula, número y carácter especial (mínimo 8 caracteres)"
            );
            return false;
          } else {
            hideError(input);
        ...
        function validateNombreApellido(input) {
          ...
          if (!pattern.test(value)) {
            showError(
              input,
              "Solo letras, espacios y caracteres españoles (2-50 caracteres)"
            );
            return false;
          } else {
            hideError(input);
        ...
        function validateEspecialidad(input) {
          if (
            document.getElementById("rol").value === "doctor" &&
            !input.value
          ) {
        ...
        function validateForm() {
          ...
          if (!validateNombreApellido(document.getElementById("nombre")))
            isValid = false;
          if (!validateNombreApellido(document.getElementById("apellido")))
            isValid = false;
          ...
          if (!validateTelefono(document.getElementById("telefono")))
            isValid = false;
          if (
            ...
            isValid = false;
          if (!validateSelect(document.getElementById("genero")))
            isValid = false;
          ...
          if (document.getElementById("rol").value === "doctor") {
            if (
              !validateEspecialidad(document.getElementById("especialidad_id"))
            )
              isValid = false;
            if (
              !validateCodigoColegiatura(
                document.getElementById("codigo_colegiatura")
              )
            )
              isValid = false;
          }
