  ...
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      <div class="card">
        <div class="card-body">
          <form
            action="${pageContext.request.contextPath}/recepcionista/nueva-cita"
            method="post"
          >
            <div class="row">
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    doctorSelect.addEventListener("change", function () {
      ...
      if (this.value) {
        ...
        fetch(
          contextPath + "/api/doctor-fechas-disponibles?doctorId=" + this.value
        )
    ...
    fechaInput.addEventListener("change", function () {
      ...
      if (doctorId && fecha) {
        ...
        fetch(
          contextPath +
            "/api/horarios-disponibles?doctorId=" +
            doctorId +
            "&fecha=" +
            fecha
        )
          .then((response) => {
            if (!response.ok) {
              throw new Error(
                "Error al cargar los horarios. Código: " + response.status
              );
            }
